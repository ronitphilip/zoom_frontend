...
import { fetchIntervalAgentQueuesAPI } from '@/services/queueAPI';
            ...
            <table className="w-full divide-y divide-gray-200 text-xs">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  {visibleColumns.agentName && <th scope="col" className="px-3 py-2 text-left text-xs font-bold text-gray-700 uppercase tracking-wider min-w-[100px] sticky top-0 bg-gray-50">Agent Name</th>}
